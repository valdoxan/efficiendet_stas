...
def create_dataset(annotation, width, height,name, root, splits=('train', 'val')):
        ...
        for s in splits:
            ...
            if isinstance(split_cfg['split_filename'], (tuple, list)):
                ...
                for sf, af, id in zip(
                    ...
                    if parser is None:
                        parser = create_parser(annotation, dataset_cfg.parser, cfg=parser_cfg)
                    else:
                        other_parser = create_parser(annotation, dataset_cfg.parser, cfg=parser_cfg)

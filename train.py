...
parser.add_argument('--dataset', default='voc0712', type=str, metavar='DATASET',
...
def create_datasets_and_loaders(
    ...
    dataset_train, dataset_eval = create_dataset(args.annotation, args.annotationW, args.annotationH, args.dataset, args.root)
